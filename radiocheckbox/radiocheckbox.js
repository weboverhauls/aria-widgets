/* Note: this source code applies to both the 
   checkbox and radio button examples.
   If you need only only one or the other, you can 
   delete the parts you don't need */
   
/* Known issues:
- VoiceOver does not announce "checked" or "unchecked" as it should
  upon hitting the space bar or enter/return key
- Safari scrolls the window view down when using the space bar 
  on the checkbox, even with preventDefault();
*/
