$(function () {
  $('#datepicker').datepicker({
    showOn: 'button',
    buttonImage: '/assets/js/aria/datepicker/images/calendar.png',
  ...
  $('.ui-datepicker-trigger').attr('aria-haspopup', 'true');
...
// This is the line that needs to be fixed for use on pages with base URL set in head
  ...
  $(container).on('keydown', function calendarKeyboardListener(keyVent) {
    ...
    if (27 === which) {
      ...
      // } else if ($(target).hasClass('ui-datepicker-current')) { Today button 
      //   $('.ui-datepicker-prev')[0].focus();
